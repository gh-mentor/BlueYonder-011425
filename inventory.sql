...
14) Create a transaction that inserts a new supplier, category, and product record.
*/
...
CREATE TABLE suppliers (
    ...
    -- add a column that holds the created date
    created_at DATETIME DEFAULT GETDATE(),
    -- add a column that holds the updated date
